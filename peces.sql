...
CREATE TABLE especies (
    ...
    temperatura    NUMERIC(2)    NOT NULL,
...
INSERT INTO especies (nombre, binomial, tamanyo, temperatura, ph, gh, min_individuos, descripcion)
VALUES ('Neón', 'Paracheirodon innesi', 4, 25, 7, 8, 10, 'Es un pez de cuerpo esbelto, el cual presenta una línea de color azul verdoso que va desde el ojo hasta poco antes de la cola, y por debajo de esta se encuentra una línea de color rojo que va de la mitad del cuerpo hasta la cola.'),
       ('Cebra', 'Danio rerio', 6, 23, 7, 8, 10, 'Una especie de cíprinido emparentados con las carpas y los barbos que, al igual que el mamífero del cual toma su nombre, está totalmente rayado en blanco y negro, por ello le sirve de camuflaje para mezclarse con la fauna marina.');
